...
export const first_outbound_email_templates = [
...
export const second_outbound_email_templates = [
...
export const third_outbound_email_templates = [
...
Visit sanfranciscofootandankle.com or reply here to own it. // notice no space in the domain and all lowercase
        `,

]

export const fourth_outbound_email_templates = [
